...
export function Ticker() {
  const items: [string, string][] = [
    ...
    ["12,000 GAL", "MAX BATCH SIZE"],
    ["3M+ GAL", "MONTHLY CAPACITY"],
  ...
  const caps = [
    {
      ...
      items: ["Blending 500–12,000 gal", "QC chemistry in-house", "Pallet-to-container"],
      icon: (
...
export function SpecSheet() {
  const specs = [
    ...
    { v: "12,000", unit: "gal", lbl: "Max batch size" },
